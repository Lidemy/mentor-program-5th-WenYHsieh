<?php
  ...
  $sql="SELECT * FROM Yu_blog_articles WHERE is_deleted != 1 ORDER BY created_at DESC limit 5 ";
...
<body>
  <nav>
    <div class="nav__option-wrapper">
      ...
      <a href="about.php" class="nav__option"> 關於我 </a>
    </div>
    <div class="nav__option-wrapper">
      <?php if ($is_login) { ?>
        <div class="nav__welcome"> 歡迎回來！ <?php echo $nickname; ?></div> 
  ...
  <div class="article">
    <div class="article__latest-wrapper">
      <div class="article__latest-banner"> 最新文章 </div>
      <?php
      ...
      <div class="article__latest">
        ...
        <div class="article__content"><?php echo substr(escape($row['content']), 0, 150) . '......'?></div>
        <a href="article.php?id=<?php echo $row['id']?>" class="article__loadmore"> 繼續閱讀</a>
      </div>
    </div>
    <div class="article__recent-wrapper">
      <div class="article__recent-banner"> 近期文章 </div>
      ...
      ?>
        <div class="article__recent">
          ...
          <div class="article__content"><?php echo substr(escape($row['content']), 0, 150) . '......'?></div>
          <a href="article.php?id=<?php echo escape($row['id'])?>" class="article__loadmore"> 繼續閱讀</a>
        </div>
      <?php }?>
    </div>
  </div>
